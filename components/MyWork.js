          ...
          <a href="https://numbergame.io" target="_blank">
            <div className="text-white flex flex-col justify-center rounded-lg p-4 motion-safe:hover:scale-110 w-96">
              ...
              <p className="pt-4">
                ...
                1,000,000. Add numbers by breeding them and complete challenges
                to win prizes. You can't add the same two numbers twice and you
                must own the numbers you breed. Most of all, just have fun ;)
              </p>
            </div>
          </a>
        </div>
